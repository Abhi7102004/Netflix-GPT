...
const VideoTitle = (props) => {
  ...
  return (
    <div className='px-14 absolute pt-[19%] aspect-video bg-gradient-to-r from-black '>
        <h1 className='text-6xl w-5/12 font-bold font-mukta'>{title}</h1>
        <h1 className='mt-4 w-1/3 line-clamp-5'>{overview}</h1>
